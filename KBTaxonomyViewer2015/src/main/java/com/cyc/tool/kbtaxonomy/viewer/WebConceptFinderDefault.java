 ...
 *
 */
public class WebConceptFinderDefault extends NanoHTTPD {
...
//  private static int port = 8082;
   ...
   */
  public WebConceptFinderDefault() {
    super(port);
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    LocalServerRunner
            .run(WebConceptFinderDefault.class
            );
  }
  ...
  private static void processOptions(String[] args) {
    ...
    try { // Processing the command line
      ...
      Logger.getLogger(WebConceptFinderDefault.class
  ...
  public NanoHTTPD.Response serve(NanoHTTPD.IHTTPSession session) {
    ...
    if (webParams.get("getNodeData") != null) {
      try {
        ...
        Logger.getLogger(WebConceptFinderDefault.class.getName()).log(Level.SEVERE, null, ex);
      }
    }
...
//    page = oViewer.addConceptSearchForm(page);
    ...
    if (oViewer.getNearestOCycQuery() != null) {
